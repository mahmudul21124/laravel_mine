            ...
            <div class="row page-titles">
                ...
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Timetable
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <form class="form-horizontal" method="post"
                                        ...
                                        <div class="input-group">
                                            <select name="classroom" id="" class="form-control">
                                                ...
                                                @foreach ($classrooms as $classroom)
                                                    <option value="{{ $classroom->id }}" @selected(old('classroom') ?? $timetable->classroom_id == $classroom->id)>
                                        ...
                                        <div class="input-group">
                                            <select name="teacher" id="" class="form-control">
                                                ...
                                                @foreach ($teachers as $teacher)
                                                    <option value="{{ $teacher->id }}" @selected(old('teacher') ?? $timetable->teacher_id == $teacher->id)>
                                                        {{ $teacher->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="input-group">
                                            <select name="subject" id="" class="form-control">
                                                ...
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ $subject->id }}" @selected(old('subject') ?? $timetable->subject_id == $subject->id)>
                                                        {{ $subject->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="exampleInputuname_4"
                                                name="day" value="{{ old('day') ?? $timetable->day}}">
                                        </div>
                                        @error('day')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="time" class="form-control" id="exampleInputuname_4"
                                                name="startTime" value="{{ old('startTime') ?? $timetable->startTime}}">
                                        </div>
                                        @error('startTime')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="time" class="form-control" id="exampleInputuname_4"
                                                name="endTime" value="{{ old('endTime')?? $timetable->endTime }}">
                                        </div>
                                        @error('endTime')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
