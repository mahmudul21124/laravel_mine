<div class="nav-header">
    <div class="brand-logo"><a href="{{url('/admin/dashboard')}}"><b><img src="{{asset('assets/images/logo.png')}}" alt=""> </b><span
                class="brand-title"><img src="{{asset('assets/images/logo-text.png')}}" alt=""></span></a>
    </div>
            ...
            <ul>
                            ...
                            <ul>
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="../../assets/images/avatar/1.jpg"
                                            alt="">
                                ...
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="../../assets/images/avatar/2.jpg"
                                            alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="../../assets/images/avatar/3.jpg"
                                            alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="../../assets/images/avatar/4.jpg"
                                            alt="">
                                        <div class="notification-content">
                    ...
                    <div class="drop-down animated bounceInDown dropdown-notfication">
                        <div class="dropdown-content-body">
                            <ul>
                                ...
                                <li><a href="javascript:void()"><span class="mr-3 avatar-icon bg-danger-lighten-2"><i
                                                class="fa fa-close"></i></span>
                                        <div class="notification-content">
                                            <div class="notification-heading">Inverness McKenzie</div><span
                                                class="notification-text">A wonderful serenit of my entire soul.</span>
                                            <small class="notification-timestamp">20 May 2018, 15:32</small>
                                        </div>
                                    </a>
                                    <span class="notify-close"><i class="ti-close"></i>
                                ...
                                <li><a href="javascript:void()"><span class="mr-3 avatar-icon bg-success-lighten-2"><i
                                                class="fa fa-check"></i></span>
                                        <div class="notification-content">
                ...
                <li class="icons">
                    <a href="javascript:void(0)" class="log-user">
                        <img src="{{asset('assets/images/avatar/1.jpg')}}" alt=""> <span>{{Auth()->guard()->user()->name}}</span> <i
                                ...
                                <li>
                                    <form action="{{ route('admin.logout') }}" method="post">
                                        ...
                                        <button class="btn btn-sm btn-danger" type="submit"><i
                                                class="fa fa-fw fa-power-off"></i>Admin Log Out</button>
                                    </form>
