            ...
            <div class="row page-titles">
                ...
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Classroom
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8 offset-2">
                    <div class="card form-card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Edit Classroom</h4>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="exampleInputuname_4"
                                                name="classroom" value="{{ old('classroom') ?? $classroom->name }}"
                                        ...
                                        <div class="input-group">
                                            <select name="teacher" id="" class="form-control">
                                                ...
                                                @foreach ($teachers as $teacher)
                                                    <option value="{{ $teacher->id }}" @selected(old('teacher') ?? $classroom->teacher_id == $teacher->id)>
                                                        {{ $teacher->name }}</option>
                                                @endforeach
