        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Classrooms</h4>
                            <div class="table-responsive">
                                <a href="{{ route('classroom.create') }}" class="btn btn-success pull-right">Add
                                    new</a><br><br>
                                    ...
                                    <tbody>
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('classroom.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('classroom.edit', $item->id) }}"
